...
class LoadStartGGDataForm(nps.ActionForm):
    ...
    def create(self):
        ...
        self.formObjs['tourneyEntry'] = self.add(nps.Textfield, value='Tournament Name: ',
                                                 name=None)

        self.placeholder = self.add(nps.FixedText, name=None,
                                    value='Load Start.gg Data Form', editable=False)

    def on_ok(self):
        return

    def on_cancel(self):
        # cancel is the same as back in this case, so we call the back handler
        self.hndlBack()
    ...
    def hndlBack(self, *args, **kwargs):
        ...
        result = nps.notify_yes_no('Return to the main screen? Unsaved Work will be lost.')
    ...
    def hndlQuit(self, *args, **kwargs):
        ...
        result = nps.notify_yes_no('Are you sure you want to close the application? Unsaved work will be lost.',
                                   title='Exit')
